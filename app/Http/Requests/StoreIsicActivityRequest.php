...
class StoreIsicActivityRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->user()?->can('create', IsicActivity::class) ?? false;
    }

    public function rules(): array
    {
        return [
            'isic_code' => ['required', 'string', 'max:10', 'unique:isic_activities,isic_code'],
